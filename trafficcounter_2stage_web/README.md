...
## Gợi ý khi đưa cho nhà tuyển dụng

Nếu chia sẻ repo này cho người khác:

- Để code trên GitHub.
- Để model, demo video và dữ liệu nặng trên Google Drive.
- Giữ README này cập nhật đúng link Drive.
- Không commit file nặng và môi trường ảo lên Git.
